...
class JssEnv(gym.Env):
    def __init__(self, products: ProductsSimulation, factory: Factory):
        """
        ...
        self.sum_op = 0
        self.jobs, self.machines = products.jobs, factory.machines
        ...
        for product in products.products:
            ...
            for sub_product in product.sub_products:
                for i in range(len(sub_product.machine_sequence)):
                    machine, time = sub_product.machine_sequence[i], sub_product.machine_time_sequence[i]
                    self.instance_matrix[job_nb][i] = (machine, time)
